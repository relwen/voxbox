...
Color buttonColor = const Color.fromARGB(255, 0, 143, 187);
Color theme = Color.fromARGB(246, 94, 1, 21);
Color theme2 = Color.fromARGB(255, 175, 3, 12);
Color buttonText = const Color(0xffFFFFFF);
Color inputFieldSeparator = Color.fromARGB(255, 0, 143, 187);
Color termsCheckBox = const Color(0xff39BF4E);
Color loaderColor = const Color.fromARGB(255, 0, 143, 187);
Color notUploadedColor = Color.fromARGB(255, 0, 143, 187);
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = Color.fromARGB(255, 0, 143, 187);
...
Color starColor = const Color(0xff1DA1F2);
